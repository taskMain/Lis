...
/// <summary>
/// 接收侧不采纳明细的行级投影：统计范围内按互认时间落入的不采纳事实及其原因代码与补充说明。
/// </summary>
/// <remarks>
/// 原因代码取平台统一原因枚举值；补充说明按业务原值返回，只在明细与导出展示，原因汇总不聚合该文本；
/// 患者姓名取自匹配项绑定报告的报告主体检索列，证件号码取匹配记录保存值。
/// </remarks>
public sealed record RecognitionNonAdoptionDetailItem
{
  ...
  /// <summary>处理结果的互认时间；不采纳口径的业务时间。</summary>
