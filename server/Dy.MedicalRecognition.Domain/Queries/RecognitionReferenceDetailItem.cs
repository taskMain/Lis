...
/// <summary>
/// 接收侧引用明细的行级投影：统计范围内按实际引用时间落入的引用事实及其引用科室与医生。
/// </summary>
/// <remarks>
/// 引用事实与匹配项被唯一索引限定为一对一，被引用项均为已采纳，处理结果字段恒有值；
/// 患者姓名取自匹配项绑定报告的报告主体检索列，证件号码取匹配记录保存值。
/// </remarks>
public sealed record RecognitionReferenceDetailItem
{
  ...
  /// <summary>处理结果的互认时间；被引用项均为已采纳，恒有值。</summary>
