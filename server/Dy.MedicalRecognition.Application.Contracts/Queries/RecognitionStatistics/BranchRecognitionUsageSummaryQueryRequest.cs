...
/// <summary>
/// 接收侧互认使用汇总查询：医院管理员入口，接收组织与接收医院由可信上下文注入。
/// </summary>
/// <remarks>
/// 请求不提交本侧组织与医院字段；本侧接收院区可选，为空时按可信医院全院范围统计，非空时必须属于可信医院；
/// 来源组织恒为可信组织，请求只提交来源组医院与院区的可选筛选。
/// 汇总维度必填，且取值必须是枚举已定义值；日期范围为必填的本地日闭区间。
/// </remarks>
public sealed record BranchRecognitionUsageSummaryQueryRequest
{
  ...
  /// <summary>本侧接收院区编码；可选，为空按可信医院全院范围统计，非空必须存在、启用且属于可信医院。</summary>
