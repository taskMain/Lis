...
public sealed record RecognitionReportContextReadModel
{
  ...
  /// 来源申请医生ID
  /// </summary>
  public string SourceApplicantDoctorId { get; set; }
  /// <summary>
  /// 来源申请医生名称
  /// </summary>
  public string SourceApplicantDoctorName { get; set; }
  /// <summary>
  /// 来源审核医生ID
  /// </summary>
  public string SourceReviewerDoctorId { get; set; }
  /// <summary>
  /// 来源审核医生名称
  /// </summary>
  public string SourceReviewerDoctorName { get; set; }
  /// <summary>
  /// 检查所见
  /// </summary>
  ...
  /// 检查结论
  /// </summary>
  public string ExaminationConclusion { get; set; }
  /// <summary>
  /// 文件信息
  /// </summary>
