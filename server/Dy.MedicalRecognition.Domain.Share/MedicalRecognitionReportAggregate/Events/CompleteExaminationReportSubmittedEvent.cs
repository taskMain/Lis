...
/// <summary>
/// 已发生的领域事实：一份完整检查报告已提交。
/// </summary>
public record CompleteExaminationReportSubmittedEvent : DomainEvent
{
  ...
  public override string EventType { get; } = nameof(CompleteExaminationReportSubmittedEvent);
