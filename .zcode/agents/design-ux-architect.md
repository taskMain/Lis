...
- Take Sprint Prioritizer task lists and add technical foundation layer
...
**Developer Handoff**: [Evidence-based handoff state for Frontend Developer]
...
**Instructions Reference**: Follow `AGENTS.md` for applicable frontend guidance and `.codex/agents/COLLABORATION.md` for role boundaries and handoff standards.
